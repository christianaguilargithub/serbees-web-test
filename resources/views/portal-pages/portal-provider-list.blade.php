  ...
  <div class="modal-container2" id="modal_container2">
    <div class="modal2">
      <div class="client-details-title">
        <p style="font-size: 18px; margin:0px; font-weight:700;">Provider Details</p> <p style="font-size: 18px; margin:0px; font-weight:700;cursor:pointer;" id="close2">&#215;</p> 
      </div>
      <div class="client-details-container">
        <div class="client-details">
          ...
          <table style="width:100%">
            <tr>
              <th style="padding-top: 20px;">Services</th>
              <td style="padding-top: 20px;">Car/Van Driver, Bookkeeping, Accounting and Tax Services, Car Rental Service</td>
            </tr>
            <tr>
            ...
            <p style="text-align:left; margin: 0px 0px 30px 5px;">blk n3 lot 3 Emmanuel Bergado I DASMARIÑAS CAVITE REGION IV-A (CALABARZON)</p>
          ...
          <div class="client-details-buttons">
            ...
            <button style=" width: 260px; height: 50px; background-color: #FEC128; color:#FFF; border-radius: 4px; margin-left:7.5px">Bypass Payment</button>
          </div>
    ...
    <div class="provider-list-container">
      <div class="portal-provider-container">
        <div class="provider-status">
            ...
            <div class="register-today">
                <p class="portal-provider-status">Pending Payments</p>
                <p class="portal-provider-status-count">326</p>
            </div>
            <div class="register-today">
